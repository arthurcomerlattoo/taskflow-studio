...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-mlAhCWqu.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-D5y0RKav.js").then((n2) => n2.a),
    import("./start-B3VE9bAb.js"),
...
var ROUTER_BASEPATH = "taskflow-studio";
var SERVER_FN_BASE = "/taskflow-studio/_serverFn/";
